...
/*
type_of() takes the three arguments of a vm command and returns an int value based on the following
table:
...
//code_generator_al() generates asm code for arithematic and logical vm 
//commands
